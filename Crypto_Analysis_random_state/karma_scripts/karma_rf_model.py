...
class KarmaRFModel:
    # Karma veri seti için Random Forest Regressor modeli
    ...
    def __init__(self, interval):
        ...
        self.model_dir = f"d:/Crypto_Analysis_random_state/karma_models/rf/{self.interval.lower()}"
    ...
    def prepare_data(self):
        ...
        print(f"\n{self.interval.capitalize()} RF modeli için veriler hazırlanıyor...")
    ...
    def train(self):
        # Modeli eğitir
        print(f"\n{self.interval.capitalize()} RF modeli eğitiliyor...")
    ...
    def _print_results(self, performance):
        ...
        print("\n" + "=" * 50)
        print(f"Karma {self.interval.capitalize()} RF modeli sonuçları")
        print("=" * 50)
...
def train_all_intervals():
    # Tüm zaman aralıkları için RF modellerini eğit
    intervals = ['daily', 'hourly', 'monthly']
    results = {}
    
    for interval in intervals:
        try:
            model = KarmaRFModel(interval)
    ...
    print("\nKarma RF modelleri eğitimi tamamlandı!")
