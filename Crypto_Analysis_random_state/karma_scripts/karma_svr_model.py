...
class KarmaSVRModel:
    ...
    def __init__(self, interval):
        ...
        self.model_dir = f"d:/Crypto_Analysis_random_state/karma_models/svr/{self.interval.lower()}"
    ...
    def prepare_data(self):
        print(f"\n{self.interval.capitalize()} SVR modeli için veriler hazırlanıyor...")
    ...
    def train(self):
        print(f"\n{self.interval.capitalize()} SVR modeli eğitiliyor...")
    ...
    def _print_results(self, performance):
        ...
        print("\n" + "=" * 50)
        print(f"Karma {self.interval.capitalize()} SVR modeli sonuçları")
        print("=" * 50)
...
def train_all_intervals():
    # Tüm zaman aralıkları için SVR modellerinin eğitilmesi
    intervals = ['daily', 'hourly', 'monthly']
    results = {}
    
    for interval in intervals:
        try:
            model = KarmaSVRModel(interval)
    ...
    print("\nKarma SVR modelleri eğitimi tamamlandı!")
