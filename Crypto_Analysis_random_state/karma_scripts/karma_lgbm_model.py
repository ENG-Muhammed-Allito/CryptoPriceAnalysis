...
class KarmaLGBMModel:
    # Karma veri seti için LightGBM Regresyon modeli
    def __init__(self, interval):
        ...
        self.model_dir = f"d:/Crypto_Analysis_random_state/karma_models/lightgbm/{self.interval.lower()}"
    ...
    def prepare_data(self):
        # Veri hazırlama
        print(f"\n{self.interval.capitalize()} LightGBM modeli için veriler hazırlanıyor...")
    ...
    def train(self):
        # Modeli eğit
        print(f"\n{self.interval.capitalize()} LightGBM modeli eğitiliyor...")
    ...
    def _save_results(self, performance):
        # Model ve performans ölçümlerini kaydet
    ...
    def _print_results(self, performance):
        ...
        print("\n" + "=" * 50)
        print(f"Karma {self.interval.capitalize()} LightGBM modeli sonuçları")
        print("=" * 50)
...
def train_all_intervals():
    # Tüm zaman aralıkları için LightGBM modellerini eğit
    print("\nKarma LightGBM modelleri eğitiliyor...")
    intervals = ['daily', 'hourly', 'monthly']
    results = {}
    
    for interval in intervals:
        try:
            model = KarmaLGBMModel(interval)
    ...
    print("\nKarma LightGBM modelleri eğitimi tamamlandı!")
